...
$users = [
    [
        ...
        'status_condition' => 'status-success',
        'avatar_img' => 'avatar-b.png',
        'name' => 'Oliver Kopyov',
    ...
    [
        ...
        'status_condition' => 'status-warning',
        'avatar_img' => 'avatar-c.png',
        'name' => 'Sesha Gray',
    ...
    [
        'card_id' => 'c_3',
        'filter_tags' => 'dr. John Cook PhD',
        'status_condition' => 'status-danger',
        'avatar_img' => 'avatar-e.png',
    ...
    [
        'card_id' => 'c_5',
        'filter_tags' => 'dr. John Oliver',
        'status_condition' => 'status-success',
        'avatar_img' => 'avatar-g.png',
        'name' => 'Dr. John Oliver',
    ...
    <body class="mod-bg-1 mod-nav-link ">
        <main id="js-page-content" role="main" class="page-content">
            ...
            <div class="row js-list-filter" id="js-contacts">
                ...
                <div class="col-xl-4">
                    <div id="<?= $user['id'] ?>" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?= $user['filter_tags']?>">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status <?= $user['status_condition']?> mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('img/demo/avatars/<?= $user['avatar_img']?>'); background-size: cover;"></span>
                                </span>
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                <a href="tel:+13174562564" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mobile-alt text-muted mr-2"></i> <?= $user['tell']?></a>
